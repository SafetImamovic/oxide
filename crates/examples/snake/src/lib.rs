...
pub fn run() -> anyhow::Result<()>
{
...

        {
                let mut res = engine
                        .resources
                        .lock()
                        .unwrap_or_else(|_| panic!("Failed to lock resources"));
        ...
        for (i, key) in [KeyCode::KeyW, KeyCode::KeyS, KeyCode::KeyA, KeyCode::KeyD]
                .iter()
                .enumerate()
        {
                ...
                if i == 0 || i == 1
                {
                        direction.y = sign as f32 * SPEED;
                        direction.x = 0.0
                }
                if i == 2 || i == 3
                {
                        direction.x = -sign as f32 * SPEED;
                        direction.y = 0.0
                }
