...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__he6e4e5bb3ec5c6bd: (a: number, b: number) => void;
  readonly closure851_externref_shim: (a: number, b: number, c: any, d: any) => void;
  readonly closure1596_externref_shim: (a: number, b: number, c: any) => void;
